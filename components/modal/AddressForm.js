      ...
      >
        <div className='max-w-xl space-y-16 md:grid md:grid-cols-2 md:gap-x-12 md:gap-y-10 md:items-baseline '>
          <div className='flex flex-col items-start justify-between gap-y-2'>
            <label className='text-sm md:min-w-max' htmlFor='provinces'>
              استان
            </label>
            <select
          ...
          <div className='flex flex-col items-start justify-between gap-y-2'>
            <label className='text-sm md:min-w-max' htmlFor='city'>
              شهرستان
            </label>
            <select
              className='border-2 rounded-sm py-0.5 px-3 outline-none w-56'
          ...
          <div className='space-y-3 '>
            <label className='text-sm md:min-w-max' htmlFor='street'>
              کوچه و خیابان
            </label>
            <input
          ...
          <div className='space-y-3 '>
            <label className='text-sm md:min-w-max' htmlFor='postalCode'>
              کد پستی
            </label>
            <input
              className='input sm:max-w-sm lg:max-w-full '
