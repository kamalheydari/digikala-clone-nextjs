  ...
  return (
    <section className="px-4 ">
      <div className="lg:flex lg:max-w-3xl lg:gap-x-20 xl:max-w-5xl">
        <h4 className="mb-3 h-fit w-min lg:border-b-2 lg:border-red-600">مشخصات</h4>
            ...
            if (!item.value) return null
              ...
              return (
                <li key={i} className="flex">
                  <span className="ml-3 w-36 py-2 font-light leading-5 tracking-wide text-gray-600">{item.title}</span>
                  <span
                    className="w-full break-all border-b border-gray-300 py-2 font-normal leading-5 tracking-wide text-gray-700 md:break-normal "
      ...
      {specification.length > 7 && (
        <button type="button" className="flex items-center py-2 text-sm text-sky-500" onClick={showSpecHandlers.toggle}>
