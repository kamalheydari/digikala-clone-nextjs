    ...
    <Menu as="div" className="dropdown">
      ...
      >
        <Menu.Items className="dropdown__items w-56">
          <Menu.Item>
            <div className="px-3 transition-colors hover:bg-gray-300/80">
              <Link
                href="/profile"
                className="flex-center mx-4 gap-x-1 py-4 text-xs font-medium text-gray-800 md:text-sm"
              >
                <Person className="h-6 w-6" />
                <span className="ml-auto mr-4 text-gray-800">{name}</span>
