  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className="relative mt-1 w-64">
        <Listbox.Button className="relative h-8 w-full cursor-default overflow-hidden rounded-lg border border-gray-300 bg-white text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-400 sm:text-sm">
          {value?.name ? (
              ...
              <Listbox.Option
                ...
                className={({ active }) =>
                  `relative cursor-default select-none py-2 pl-10 pr-4 ${
                    active ? 'bg-amber-100 text-amber-950' : 'text-gray-950'
                  }`
                }
                value={item}
              >
