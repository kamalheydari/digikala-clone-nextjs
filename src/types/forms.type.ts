...
export type IProductForm = Omit<
  IProduct,
  '_id' | 'createdAt' | 'updatedAt' | 'sold' | 'numReviews' | 'rating' | 'info' | 'specification' | 'category_levels'
> & {
...
export type IReviewForm = Pick<IReview, 'rating' | 'title' | 'negativePoints' | 'positivePoints' | 'comment'>
