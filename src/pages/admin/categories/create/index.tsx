...
import { CategoryForm, DashboardLayout, HandleResponse, PageContainer } from 'components'
...
const Create: NextPage = () => {
  ...
  // ? Queries
  //*   Create Category
  const [createCtegory, { data, isSuccess, isLoading, error, isError }] = useCreateCategoryMutation()
      ...
      <main>
        ...
        <DashboardLayout>
          <PageContainer title="دسته بندی جدید">
            <CategoryForm mode="create" isLoading={isLoading} parentLvl={parentLvl} createHandler={createHandler} />
          </PageContainer>
        </DashboardLayout>
      </main>
    </>
