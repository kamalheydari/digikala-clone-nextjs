                        ...
                        <td className="flex flex-wrap items-center gap-3 px-2 py-4">
                          {category.level !== 3 && (
                            <Link
                              ...
                              className="max-w-min rounded-sm bg-green-200 px-2 py-1 text-green-600"
                            >
                              زیردسته ها
                            </Link>
                          )}
                          <Link
                            ...
                            className="max-w-min rounded-sm bg-amber-100 px-2 py-1 text-amber-600"
                          >
                            ویرایش
                          </Link>
                          {category.level === 2 && (
                            <Link
                              ...
                              className="max-w-min rounded-sm bg-blue-300 px-2 py-1 text-blue-600"
                            >
                              مشخصات و ویژگی ها
                            </Link>
                          )}
                          {category.level < 2 && (
                            <>
                              <Link
                                ...
                                className="max-w-min rounded-sm bg-fuchsia-300 px-2 py-1 text-fuchsia-600"
                              >
                                اسلایدرها
                              </Link>
                              <Link
                                href={`/admin/banners?category_id=${category._id}&category_name=${category.name}`}
                                className="max-w-min rounded-sm bg-rose-200 px-2 py-1 text-rose-600"
                              >
                                بنرها
                              </Link>
                            </>
