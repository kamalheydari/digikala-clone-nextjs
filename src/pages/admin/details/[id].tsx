...
const DetailsPage: NextPage = () => {
  ...
  // ? Handlers
  //*   Create
  const createHandler: SubmitHandler<IDetailsForm> = async ({ info, specification, optionsType }) => {
    await createDetails({
      body: {
  ...
  //*   Update
  const updateHandler: SubmitHandler<IDetailsForm> = ({ info, specification, optionsType }) => {
    setUpdateInfo((prev) => ({
      ...prev,
      ...details,
      info,
                    ...
                    <Tab.Panel>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-x-1">
                          <input type="radio" id="none" value="none" className="ml-1" {...register('optionsType')} />
                        ...
                        <div className="flex items-center gap-x-1">
                          <input type="radio" id="sizes" value="sizes" className="ml-1" {...register('optionsType')} />
